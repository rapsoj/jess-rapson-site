...
<img src="{{ '/assets/images/updates/2026/january/jessica-rapson-icpac-nairobi.jpg' | absolute_url }}" alt="Jessica Rapson presenting the INFLOW-AI flood forecasting model to engineers at ICPAC in Nairobi" loading="lazy" decoding="async">
...
<img src="{{ '/assets/images/updates/2026/january/jessica-rapson-rccc-london.jpg' | absolute_url }}" alt="Jessica Rapson speaking at the Red Cross Climate Centre 2030 Strategic Vision session in London" loading="lazy" decoding="async">
...
![no-alignment]({{ '/assets/images/updates/2026/january/canada.png' | absolute_url }})
*I'm so back.*

![no-alignment]({{ '/assets/images/updates/2026/january/tree_hugging.jpeg' | absolute_url }})
*Classic BC hike.*

![no-alignment]({{ '/assets/images/updates/2026/january/creek.jpeg' | absolute_url }})
*Top of a pretty impressive waterfall.*

![no-alignment]({{ '/assets/images/updates/2026/january/railway.JPEG' | absolute_url }})
*Walking across an abandoned railway high above the trees.*

![no-alignment]({{ '/assets/images/updates/2026/january/alley.png' | absolute_url }})
*Alley in Victoria Chinatown.*

![no-alignment]({{ '/assets/images/updates/2026/january/peacock.JPG' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2026/january/bug_zoo1.png' | absolute_url }})
*Fun phasmid at the [Victoria Bug Zoo](https://www.victoriabugzoo.ca/).*

![no-alignment]({{ '/assets/images/updates/2026/january/bug_zoo2.png' | absolute_url }})
*Some walking sticks can reproduce asexually, in a process called parthenogenesis.*

![no-alignment]({{ '/assets/images/updates/2026/january/drawing.png' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2026/january/oxford_view.JPG' | absolute_url }})
