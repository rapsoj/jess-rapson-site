...
![Jessica Rapson presenting flood forecasting model at ICPAC Nairobi]({{ '/assets/images/updates/2026-01-january/jessica-rapson-icpac-nairobi.jpg' | absolute_url }})
...
![Jessica Rapson speaking at Red Cross Climate Centre London]({{ '/assets/images/updates/2026-01-january/jessica-rapson-rccc-london.jpg' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2026-01-january/canada.png' | absolute_url }})
*I'm so back.*

![no-alignment]({{ '/assets/images/updates/2026-01-january/tree_hugging.jpeg' | absolute_url }})
*Classic BC hike.*

![no-alignment]({{ '/assets/images/updates/2026-01-january/creek.jpeg' | absolute_url }})
*Top of a pretty impressive waterfall.*

![no-alignment]({{ '/assets/images/updates/2026-01-january/railway.JPEG' | absolute_url }})
*Walking across an abandoned railway high above the trees.*

![no-alignment]({{ '/assets/images/updates/2026-01-january/alley.png' | absolute_url }})
*Alley in Victoria Chinatown.*

![no-alignment]({{ '/assets/images/updates/2026-01-january/peacock.JPG' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2026-01-january/bug_zoo1.png' | absolute_url }})
*Fun phasmid at the [Victoria Bug Zoo](https://www.victoriabugzoo.ca/).*

![no-alignment]({{ '/assets/images/updates/2026-01-january/bug_zoo2.png' | absolute_url }})
*Some walking sticks can reproduce asexually, in a process called parthenogenesis.*

![no-alignment]({{ '/assets/images/updates/2026-01-january/drawing.png' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2026-01-january/oxford_view.JPG' | absolute_url }})
