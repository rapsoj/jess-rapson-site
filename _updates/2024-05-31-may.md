...
<img src="{{ '/assets/images/updates/2024/may/jessica-rapson-oxford-graduation-portrait.png' | absolute_url }}" alt="Jessica Rapson in academic dress at her University of Oxford graduation" loading="lazy" decoding="async">
*I've removed the watermark and upscaled the potato-quality sample photo using AI, so if it looks weird that's why.*

<img src="{{ '/assets/images/updates/2024/may/jessica-rapson-oxford-graduation-ceremony.png' | absolute_url }}" alt="Jessica Rapson attending her University of Oxford graduation ceremony" loading="lazy" decoding="async">
*Do fidem.*
