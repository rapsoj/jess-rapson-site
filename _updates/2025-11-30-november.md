...
![no-alignment]({{ '/assets/images/updates/2025/november/methodist-central-hall.png' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2025/november/policy-engine.png' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2025/november/chalk-rivers.png' | absolute_url }})
*Flooding in chalk rivers, pictured here, is more affected by groundwater than rainfall.*

![no-alignment]({{ '/assets/images/updates/2025/november/baseflow.png' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2025/november/office.png' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2025/november/uk-nowcast1.JPEG' | absolute_url }})
*I'm not entirely sure people in the UK are aware just how well Reform is poling now.*

![no-alignment]({{ '/assets/images/updates/2025/november/uk-nowcast2.JPEG' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2025/november/corbyn.png' | absolute_url }})
*Got to meet Corbyn at the Oxford rally.*

I'm technically a member of the Green Party and am also volunteering for them.

![no-alignment]({{ '/assets/images/updates/2025/november/meme.png' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2025/november/three-years.png' | absolute_url }})
*Three years!*

![no-alignment]({{ '/assets/images/updates/2025/november/london.png' | absolute_url }})
*On my way to London for the PolicyEngine event.*

![no-alignment]({{ '/assets/images/updates/2025/november/mr-business.png' | absolute_url }})
...
![no-alignment]({{ '/assets/images/updates/2025/november/museum-art.png' | absolute_url }})
